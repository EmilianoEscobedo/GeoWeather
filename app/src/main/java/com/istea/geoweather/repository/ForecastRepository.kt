...
class ForecastRepositoryImpl(private val service: OpenWeatherService) : ForecastRepository {
    companion object {
        private const val LOG_TAG = "ForecastRepository"
    }

    override suspend fun getForecast(lat: Double, lon: Double, limit: Int): Forecast {
        try {
